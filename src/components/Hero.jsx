...
const Hero = () => {
  return (
    ...
    <div className='grid grid-cols-1 sm:grid-cols-3 gap-8 max-w-[1200px] h-[70h] mx-auto py-8 bg-black'>
        ...
        <div className='col-span-2 px-5 my-auto'>
            ...
            <p className='text-white sm:text-lg my-6 lg:text-xl'>
                My name is Chathuni De Alwis and I have 2 years experience in web development.
            </p>
