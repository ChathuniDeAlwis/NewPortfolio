      ...
      <div class="max-w-[800px] mx-auto">
        <div class="mt-6 bg-[#161616] rounded-xl">
            <div class="p-10">
                ...
                <form action="https://getform.io/f/lakmewoa" method='POST'>
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-x-5 gap-y-4">
                        <div>
                            <div class="mt-2.5"> 
                                <input type="text" name='textname' id='' placeholder='Your Name '
                        ...
                        <div class="sm:col-span-2">
                            <div class="mt-2.5 "> 
                                <textarea name="textareaname"  id='' placeholder='Your Message '
                                class="bg-[#161616] w-full px-4 py-4 text-gray-400 placeholder-gray-400 border
